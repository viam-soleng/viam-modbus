...
func (r *ModbusAnalogPin) Read(ctx context.Context, extra map[string]interface{}) (board.AnalogValue, error) {
	...
	switch r.dataType {
	case "int16":
		val, err := r.board.client.ReadInt16(r.offset, r.pinType, unitID)
		return board.AnalogValue{Value: int(val)}, err
	case "int32":
		val, err := r.board.client.ReadInt32(r.offset, r.pinType, unitID)
		return board.AnalogValue{Value: int(val)}, err
	case "uint8":
		val, err := r.board.client.ReadUInt8(r.offset, r.pinType, unitID)
		return board.AnalogValue{Value: int(val)}, err
	case "uint16":
		val, err := r.board.client.ReadUInt16(r.offset, r.pinType, unitID)
		return board.AnalogValue{Value: int(val)}, err
	case "uint32":
		val, err := r.board.client.ReadUInt32(r.offset, r.pinType, unitID)
		return board.AnalogValue{Value: int(val)}, err
	case "uint64":
		val, err := r.board.client.ReadUInt64(r.offset, r.pinType, unitID)
		return board.AnalogValue{Value: int(val)}, err
	case "float32":
		val, err := r.board.client.ReadFloat32(r.offset, r.pinType, unitID)
		return board.AnalogValue{Value: int(val)}, err
	case "float64":
		val, err := r.board.client.ReadFloat64(r.offset, r.pinType, unitID)
		return board.AnalogValue{Value: int(val)}, err
	default:
...
func (r *ModbusAnalogPin) Write(ctx context.Context, value int, extra map[string]interface{}) error {
	...
	switch r.dataType {
	case "int16":
		return r.board.client.WriteUInt16(r.offset, uint16(value), unitID)
	case "uint16":
		return r.board.client.WriteUInt16(r.offset, uint16(value), unitID)
	case "int32":
		return r.board.client.WriteUInt32(r.offset, uint32(value), unitID)
	case "uint32":
		return r.board.client.WriteUInt32(r.offset, uint32(value), unitID)
	case "uint64":
		return r.board.client.WriteUInt64(r.offset, uint64(value), unitID)
	case "float32":
		return r.board.client.WriteFloat32(r.offset, float32(value), unitID)
	case "float64":
		return r.board.client.WriteFloat64(r.offset, float64(value), unitID)
	default:
